...
Use this when you want to open Pericode (PP Edition) from another device (phone, tablet, another laptop).

## CLI ↔ Env option map

The Pericode (PP Edition) CLI accepts the following configuration options, available either as CLI flags or environment variables:
